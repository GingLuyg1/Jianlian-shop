...
export default function AccountShell({ children }: { children: ReactNode }) {
  ...
  if (pathname === "/account/orders") {
    return (
      <PublicLayout contentClassName="box-border flex h-[calc(100dvh-62px)] overflow-hidden px-4 py-3 md:px-6">
        <div className="mx-auto flex min-h-0 w-full max-w-[1540px] flex-1 flex-col gap-4">
          {emailNotice}
          {children}
        </div>
      </PublicLayout>
